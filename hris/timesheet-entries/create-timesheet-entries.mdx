...
<AccordionGroup>
  ...
  <Accordion title="UKG Ready">
    <p>
  Use the <a href="https://docs.bindbee.dev/hris/timesheet-entries/get-create-timesheet-meta" target="_blank"><strong>Get Create Timesheet Meta</strong></a> endpoint to retrieve the required schema and values.
</p>
  </Accordion>
