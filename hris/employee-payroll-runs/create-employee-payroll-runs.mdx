...
<AccordionGroup>
  <Accordion title="Workday">
    <p>
    When the underlying HRIS is <strong>Workday</strong>
    , an `earning` can be created using a payload like:
  ...
  <Accordion title="SAP SuccessFactors (SAP SF)">
    <p>
    When the underlying HRIS is <strong>SAP SuccessFactors</strong>
    , an `employee_payroll_run` can be created using a payload like:
