...
<Accordion title="SAP SuccessFactors (SAP SF)">
    <p>
      When the underlying HRIS is <strong>SAP SuccessFactors</strong>, an
      `employee_payroll_run` can be created using a payload like:
    </p>
    ...
    - <code>earnings</code>, <code>deductions</code>, and <code>taxes</code> can be sent together.
