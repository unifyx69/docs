---
title: "Bindbee Connect"
description: "With Bindbee Connect, you can directly integrate our suite of HRIS, Payroll, and ATS solutions into the frontend of your application. This allows for quick and easy setup with minimal coding required. Your customers will be able to seamlessly integrate with any HRIS, ATS, and Payroll systems directly from your app in just minutes."
---

Post this, your customers will be able to integrate with any HRIS, ATS and Payroll directly from your app.

## Add Bindbee Connect in your product

Bindbee Connect uses four steps to securely authenticate your customer's integrations and allow you to embed the entire magic link flow inside your own product.

**Step 1:** Generate a `link_token` to initialize a BindBee Connect session for your end user.

**Step 2:** Embed BindBee Connect in your frontend using the [React SDK](https://www.npmjs.com/package/@bindbee/react-link).
