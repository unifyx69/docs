...
<Warning>
  ...
  These environments are completely isolated. Make sure to use the appropriate API key for your use case. Learn more about [Development](/features/environments/development) and [Production](/features/environments/production) environments.
</Warning>
